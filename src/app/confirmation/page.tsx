  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-navy mb-3">Demande envoyée !</h1>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-8">
          <div className="flex items-center gap-3 text-left">
            ...
            <div>
              <p className="font-semibold text-navy text-sm">Prochaine étape</p>
        ...
        <button
          ...
          className="px-6 py-3 rounded-xl bg-navy text-white font-semibold hover:bg-navy-light transition-colors"
        >
          Nouvelle demande
        </button>
      </div>
