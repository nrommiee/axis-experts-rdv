...
|---|-------|----------|----------|
| 1 | Slide In | Slide from bottom | Smooth entry |
| 2 | Zoom In | Zoom animation | Focused entry |

---

## 1. Slide In

Combobox menu slides in from bottom.
...
Combobox menu with zoom animation.
...
export default ComboboxZoomInDemo
```
