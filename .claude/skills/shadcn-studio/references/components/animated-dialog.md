...
Collection de 3 variantes de Animated Dialog de shadcn-studio.

## Référence Rapide

| # | Nom | Description |
|---|-----|-------------|
| 1 | Slide to Top | Animation slide depuis le bas |
| 2 | Slide to Right | Animation slide depuis la gauche |
| 3 | Zoom In | Animation zoom in |

---

## Animated Dialog 1 - Slide to Top

Animation slide depuis le bas vers le haut.
...
## Animated Dialog 2 - Slide to Right

Animation slide depuis la gauche vers la droite.
