...
|---|-------|-----------|----------|
| 1 | Stretch | Thumb stretches on toggle | Modern toggles with fluid motion |
| 2 | Stretch | Thumb stretches on toggle | Modern toggles with fluid motion |

> Note: Both variants use the same stretch animation with Motion (Framer Motion). They support 3 sizes: `sm`, `md`, `lg`.

---

## 1. Stretch Animation

Switch with stretching thumb animation using Motion. Available in 3 sizes.
...
## 2. Stretch Animation (Variant)

Identical implementation to variant 1. Same stretch animation with Motion.
