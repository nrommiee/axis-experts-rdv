...
| 2 | 3D Hover | Perspective tilt on hover | Product showcase, portfolios |

---

## 1. Spotlight

Card with glowing spotlight effect that follows the cursor.
...
Card with 3D perspective tilt effect on hover.
