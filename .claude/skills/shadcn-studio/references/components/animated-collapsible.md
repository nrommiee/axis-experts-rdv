# Animated Collapsible Components

1 variant from ShadcnStudio.

## Quick Reference

| # | Style | Features | Use Case |
|---|-------|----------|----------|
| 1 | Animated | Slide up/down animation | Smooth expand/collapse |

---

## 1. Animated

Collapsible with CSS animation classes for smooth transitions.
...
Add these keyframes and animations to your `tailwind.config.js`:
